...
export class AuthService {
  ...
  loginSQL(data, opt) {
    ...
    return this.http
      .post(
        "http://147.163.213.39:3000/api/login",
  ...
  registerSQL(data, opt) {
    ...
    return this.http
      .post(
        "http://147.163.213.39:3000/api/register",
        {
  ...
  memoId(email): Observable<any> {
    return this.http
      .post(
        "http://147.163.213.39:3000/api/user/memo/id",
        {
          email: email.email
        }
      )
  ...
  memoCreate(id, user, memo, date, time): Observable<any> {
    return this.http
      .post(
        "http://147.163.213.39:3000/api/user/memo/create",
        {
          id_memo: id,
          id_user: user,
          date: date,
  ...
  memo(id) {
    return this.http
      .post<Memos>(
        "http://147.163.213.39:3000/api/user/memo",
        {
          id: id,
        }
      )
