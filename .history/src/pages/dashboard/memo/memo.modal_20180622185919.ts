...
export class MemoModal {
  ...
  constructor(
    ...
    this.title = this.params.get("memo").title;
  }

  edit() {
    this.service.memoEdit(this.params.get("memo").id_user, this.params.get("memo").id_memo, this.title, this.fullDate.data, this.fullDate.time)
  }
