...
export class NoteTab implements OnInit {
  ...
  toggle(item) {
    console.log(item)
    console.log(this.collections[item.name])
    console.log(this.notes[item.name])
    console.log(this.read_prop(this.notes, item.name))
    /*let noteModal = this.modalCtrl.create(NoteModal, { note: item });
