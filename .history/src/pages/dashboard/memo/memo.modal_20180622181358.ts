...
data: any;
  constructor (
    ...
    switch (this.memo.date_time.split(" ")[2]) {
        case "Gennaio": let 01; break;
        case "Febbraio": let 02; break;
        case "Marzo": let 03; break;
        case "Aprile": let 04; break;
        case "Maggio": let 05; break;
        case "Giugno": let 07; break;
        case "Luglio": let 08; break;
