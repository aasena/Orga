...
month: string;
  constructor (
    ...
    switch (this.memo.date_time.split(" ")[2]) {
        ...
        case "Novembre": this.month = '11'; break;
        case "Dicembre": this.month = '12'; break;
    }
    this.data = this.memo.date_time.split(" ")[3].replace(',', '') + '-' + this.month + '-' + this.memo.date_time.split(" ")[1]
    this.time = this.memo.date_time.split(" ")[4].split(":")[0]
  }
