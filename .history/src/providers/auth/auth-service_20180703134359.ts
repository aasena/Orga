      ...
      await this.googlePlus
        ...
        firebase.auth().signInWithCredential(firebase.auth.GoogleAuthProvider.credential(res.idToken))
          .then( success => {
            ...
            console.log("success.email: " + success.email)
            let x = JSON.parse(success);
            console.log("stringigy success.email: " + suxccess)
            console.log("stringigy success.email: " + success)
          })
