...
export class AuthService {
  ...
  registerSQL(data, opt) {
    ...
    return this.http
      .post(
        "http://192.168:3000/api/register",
        {
  ...
  memoId(email): Observable<any> {
    return this.http
      .post(
        "http://192.168:3000/api/user/memo/id",
        {
          email: email.email
        }
      )
  ...
  memoCreate(id, user, memo, date, time): Observable<any> {
    return this.http
      .post(
        "http://192.168:3000/api/user/memo/create",
        {
          id_memo: id,
          id_user: user,
          date: date,
  ...
  memo(id) {
    return this.http
      .post<Memos>(
        "http://192.168:3000/api/user/memo",
        {
          id: id,
        }
      )
