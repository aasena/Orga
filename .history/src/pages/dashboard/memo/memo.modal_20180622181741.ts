...
month: string;
  constructor (
    ...
    switch (this.memo.date_time.split(" ")[2]) {
        ...
        case "Giugno": this.month = '07'; break;
        case "Luglio": this.month = '08'; break;
        case "Agosto": this.month = '09'; break;
        case "Settembre": this.month = '10'; break;
        case "Ottobre": this.month = '11'; break;
